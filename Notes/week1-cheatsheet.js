...
// Unary + / - (coerce to number, or negate): attched to a value themselves
// console.log(+"123"); // 123
// console.log(+"abc"); // NaN
// console.log(-"5");   // -5

// Increment / Decrement unary operator: increases or decreases by 1 only
// let c = 10;
// console.log(++c); // 11 (prefix)
// console.log(c++); // 11 (postfix), then c becomes 12 (will go to 12 after this line)
...
/* =========================
   ...
   ========================= */
/*
&& conjunction (AND), || alternative (OR), ! negation (NOT)

Short-circuiting with non-boolean values:
- A && B returns A if A is falsy, otherwise B
- A || B returns A if A is truthy, otherwise B

London is a city AND in the UK. ===> true && true === true
London is a city AND in France. ===> true && false === false

London is a city OR in France. ===> true || false === true
London is not a city OR in France. ===> false || false === false
...
if (userAge >= 21) {
   if (cartValue >= 300 || points >= 500) {
      shippingcost = 0;
      let total = cartValue + shippingcost;
      console.log(total);
   }  
   let total = cartValue + shippingcost;
   console.log(total);
   ...
   console.log("You must be 21 to access this site");
};

console.log(shippingcost);

//else statement --> attaches to if statement
/*
syntax: 
if (condition) {
   // code to run if condition is true
...
/*
Allows us to check multiple conditions now........
only one codition gets run
...
//    }else{ 
//       if (cartValue < 300) {
//       console.log("You need to have at least 300 or above in order to get free shipping");
//    }else if (points < 500) {
//       console.log("You need to have at least 500 points to get free shipping");
//    }
//    let total = cartValue + shippingcost;
//    console.log(total);
// }
...
// confirm() --> gives a user a message and takes a boolean in response, ok === true, cancel === false
// prompt() --> gives a user a message and the input is the string returned by the user
// alert() --> pops up a message to the user

alert("Hello, this is an alert message!");

let checkAge = confirm("Are you over 21 years old?");

prompt("How many points do you have?");
